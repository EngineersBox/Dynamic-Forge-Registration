package com.engineersbox.expandedfusion.core.registration.provider.elements.fluid;
...
public class FluidProviderRegistrationResolver extends RegistrationResolver {
    ...
    private final ImplClassGroupings<FluidImplGrouping> implClassGroupings;
