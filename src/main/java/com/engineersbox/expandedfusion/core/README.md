...
| `@LocaleEntry`  | Defines a mapping between an element of `com.engineersbox.expandedfusion.core.registration.annotation.processors.meta.lang.LangKey` and a human readable naming.                                                                                                                                            |
